...
### CHANGED
- Embedding провайдер: DeepInfra стал КАНОНИЧЕСКИМ (был Fireworks, до этого SiliconFlow)
- `infrastructure-matrix.yml`: embedding_provider обновлён SiliconFlow -> DeepInfra
- Карточка `qwen3-embedding-8b`: рекомендация обновлена (Scaleway -> DeepInfra)

### ADDED
- Карточка `qwen3-reranker-8b__20260225160000.md` (ранее отсутствовала)

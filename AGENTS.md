...
- [[architecture-standard__20260210103631-02]] : true — требования к файлу ARCHITECTURE__20260210103632-01.md (С YAML frontmatter) | notes: 
...
context_analysis_instructions: >
  При анализе контекста проекта для заполнения заглушек (README.md, ARCHITECTURE__20260210103632-01.md)

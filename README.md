...
updated: 2026-02-14
type: note
summary: 'Атомарная база знаний IT-инфраструктуры. Единый каталог всего инструментария: софт, железо, нейросети, серверы, MCP-серверы, интеграции и их взаимосвязи.'
---

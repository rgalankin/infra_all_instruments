...
> - [Реестр нейросетей](./neural-networks__20260201232828.md) — модели для интеграции через Groq/OpenRouter
> - [Claude Desktop](./claude-desktop__20260201200225.md) — MCP-n8n интеграция

...
title: n8n
summary: >
  Движок автоматизаций на VPS Beget: 8 workflows, 8 credentials, Bitrix24/Telegram/ASR.
type: spec
status: active
tags: [platform/docker, eng/automation, infra/vps]
source: roman
ai_weight: high
created: 2026-02-01
updated: 2026-03-08
...
- **Версия:** 2.10.4 (обновлено 2026-03-08, custom image с ffmpeg/ffprobe)
- **Статус:** активно
...
- Образ Docker: `n8n-custom:latest` (base: `n8nio/n8n:2.10.4`, + ffmpeg/ffprobe)
- Статус: активно
...
- **БД:** SQLite (не PostgreSQL), бэкапы: `/tmp/n8n_database_backup_*.sqlite`
- **Deprecation:** N8N_RUNNERS_ENABLED больше не нужен (можно удалить из .env)
...
- [[infra_all_instruments/docs/tools/claude-desktop__20260201200225|Claude Desktop]] — MCP-n8n интеграция
- [[infra_all_instruments/docs/infrastructure/vps-beget__20260210220200-01|VPS Beget]] — хостинг n8n (Docker)
- [[infra_all_instruments/docs/mcp/cards/n8n-dev__20260210220300-10|MCP: n8n-dev]] — MCP-сервер для разработки
- [[infra_all_instruments/docs/mcp/cards/n8n-prod__20260210220300-11|MCP: n8n-prod]] — MCP-сервер production
- [[infra_all_instruments/docs/tools/telegram__20260210220600-04|Telegram]] — webhook, лиды, n8n-бот
- [[infra_all_instruments/docs/tools/bitrix24__20260210220600-05|Bitrix24]] — CRM-интеграция (скорринг, звонки)
- [[infra_all_instruments/docs/neural-networks/cards/faster-whisper__20260211120000-01|Faster-Whisper]] — ASR через n8n webhook
- [[infra_all_instruments/docs/integrations/n8n-workflows__20260210220500-01|n8n Workflows]] — граф воркфлоу и связей

## История

- 2026-03-08: Обновлено 2.4.8 -> 2.10.4 (Phase 2 масштабного обновления). Custom image пересобран.

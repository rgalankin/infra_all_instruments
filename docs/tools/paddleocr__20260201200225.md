...
> **Связанные документы:**
> - [Реестр нейросетей](./neural-networks__20260201232828.md) — рекомендуемые модели для улучшения OCR
> - [Tesseract OCR](./tesseract-ocr__20260201200225.md) — альтернативный OCR

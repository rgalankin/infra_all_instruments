...
summary: >
  Архивный монолитный реестр нейросетей. Заменён атомарными карточками в docs/neural-networks/.
type: spec
status: archived
tags: [infra/ai, infra/models, docops/archive]
source: roman
ai_weight: low
created: 2026-02-01
updated: 2026-02-11
...
> **АРХИВ.** Этот файл заменён атомарными карточками.
> Актуальная версия: [[infra_all_instruments/docs/neural-networks/_index__20260210220000-05|Реестр нейросетей]]
...
> - [n8n](./n8n__20260201200225.md) — интеграции с LLM через workflows
> - [Cursor](./cursor__20260201200225.md) — настройки Continue и MCP серверов
> - [Claude Desktop](./claude-desktop__20260201200225.md) — MCP серверы для Claude
> - [PaddleOCR](./paddleocr__20260201200225.md) — OCR для русского языка
> - [Tesseract OCR](./tesseract-ocr__20260201200225.md) — базовый OCR
> - [Warp](./warp__20260201200225.md) — терминал с AI-агентами
...
> См. также: [PaddleOCR](./paddleocr__20260201200225.md), [Tesseract OCR](./tesseract-ocr__20260201200225.md)
...
> См. также: [Cursor](./cursor__20260201200225.md), `~/.continue/config.yaml`
...
> См. также: [n8n](./n8n__20260201200225.md)

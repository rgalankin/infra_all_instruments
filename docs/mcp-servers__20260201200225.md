...
summary: >
  Архивный монолитный файл MCP-серверов. Заменён атомарными карточками в docs/mcp/.
type: spec
status: archived
tags: [infra/mcp, docops/archive]
source: roman
ai_weight: low
created: 2026-02-01
updated: 2026-02-11
...
> Актуальная версия: [[infra_all_instruments/docs/mcp/_index__20260210220000-06|Реестр MCP-серверов]]
